...
namespace resqml2_0_1test {
	class ContinuousPropertyOnPartialGridTest : public ContinuousPropertyTest {
	public:
		/**
		...
		*/
		ContinuousPropertyOnPartialGridTest(const std::string & epcDocPath);
		...
		*/
		ContinuousPropertyOnPartialGridTest(common::EpcDocument * epcDoc, bool init);
	protected:
