...
public class WellboreTrajectoryRepresentation : f2i.energisticsStandardsApi.resqml2_0.AbstractRepresentation {
  ...
  internal WellboreTrajectoryRepresentation(global::System.IntPtr cPtr, bool cMemoryOwn) : base(f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          f2i.energisticsStandardsApi.energisticsApiPINVOKE.delete_resqml2_0_WellboreTrajectoryRepresentation(swigCPtr);
        }
  ...
  public uint getWellboreFrameRepresentationCount() {
    uint ret = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getWellboreFrameRepresentationCount(swigCPtr);
  ...
  public f2i.energisticsStandardsApi.resqml2_0.WellboreFrameRepresentation getWellboreFrameRepresentation(uint index) {
		global::System.IntPtr cPtr = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getWellboreFrameRepresentation(swigCPtr, index);
  ...
  public string getMdDatumUuid() {
    string ret = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getMdDatumUuid(swigCPtr);
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public f2i.energisticsStandardsApi.resqml2_0.MdDatum getMdDatum() {
    global::System.IntPtr cPtr = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getMdDatum(swigCPtr);
  ...
  public void addParentTrajectory(double kickoffMd, double parentMd, f2i.energisticsStandardsApi.resqml2_0.WellboreTrajectoryRepresentation parentTrajRep) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_addParentTrajectory(swigCPtr, kickoffMd, parentMd, f2i.energisticsStandardsApi.resqml2_0.WellboreTrajectoryRepresentation.getCPtr(parentTrajRep));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }

  public void getTangentVectors(SWIGTYPE_p_double tangentVectors) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getTangentVectors(swigCPtr, SWIGTYPE_p_double.getCPtr(tangentVectors));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }

  public void getMdValues(SWIGTYPE_p_double values) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getMdValues(swigCPtr, SWIGTYPE_p_double.getCPtr(values));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }

  public void setWitsmlTrajectory(f2i.energisticsStandardsApi.witsml1_4_1_1.Trajectory witsmlTraj) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_setWitsmlTrajectory(swigCPtr, f2i.energisticsStandardsApi.witsml1_4_1_1.Trajectory.getCPtr(witsmlTraj));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }

  public f2i.energisticsStandardsApi.witsml1_4_1_1.Trajectory getWitsmlTrajectory() {
    global::System.IntPtr cPtr = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_WellboreTrajectoryRepresentation_getWitsmlTrajectory(swigCPtr);
