...
public class SubRepresentation : f2i.energisticsStandardsApi.resqml2_0.AbstractRepresentation {
  ...
  internal SubRepresentation(global::System.IntPtr cPtr, bool cMemoryOwn) : base(f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          f2i.energisticsStandardsApi.energisticsApiPINVOKE.delete_resqml2_0_SubRepresentation(swigCPtr);
        }
  ...
  public void pushBackSubRepresentationPatch(resqml2__IndexableElements elementKind, uint elementCount, SWIGTYPE_p_unsigned_int elementIndices, f2i.energisticsStandardsApi.resqml2_0.HdfProxy proxy) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_pushBackSubRepresentationPatch__SWIG_0(swigCPtr, (int)elementKind, elementCount, SWIGTYPE_p_unsigned_int.getCPtr(elementIndices), f2i.energisticsStandardsApi.resqml2_0.HdfProxy.getCPtr(proxy));
  ...
  public void pushBackSubRepresentationPatch(resqml2__IndexableElements elementKind0, resqml2__IndexableElements elementKind1, uint elementCount, SWIGTYPE_p_unsigned_int elementIndices0, SWIGTYPE_p_unsigned_int elementIndices1, f2i.energisticsStandardsApi.resqml2_0.HdfProxy proxy) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_pushBackSubRepresentationPatch__SWIG_1(swigCPtr, (int)elementKind0, (int)elementKind1, elementCount, SWIGTYPE_p_unsigned_int.getCPtr(elementIndices0), SWIGTYPE_p_unsigned_int.getCPtr(elementIndices1), f2i.energisticsStandardsApi.resqml2_0.HdfProxy.getCPtr(proxy));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool isElementPairBased(uint patchIndex) {
    bool ret = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_isElementPairBased(swigCPtr, patchIndex);
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public resqml2__IndexableElements getElementKindOfPatch(uint patchIndex, uint elementIndicesIndex) {
    resqml2__IndexableElements ret = (resqml2__IndexableElements)f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_getElementKindOfPatch(swigCPtr, patchIndex, elementIndicesIndex);
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public uint getElementCountOfPatch(uint patchIndex) {
    uint ret = f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_getElementCountOfPatch(swigCPtr, patchIndex);
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void getElementIndicesOfPatch(uint patchIndex, uint elementIndicesIndex, SWIGTYPE_p_unsigned_int elementIndices) {
    f2i.energisticsStandardsApi.energisticsApiPINVOKE.resqml2_0_SubRepresentation_getElementIndicesOfPatch(swigCPtr, patchIndex, elementIndicesIndex, SWIGTYPE_p_unsigned_int.getCPtr(elementIndices));
    if (f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Pending) throw f2i.energisticsStandardsApi.energisticsApiPINVOKE.SWIGPendingException.Retrieve();
  }
