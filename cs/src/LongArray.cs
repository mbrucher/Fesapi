...
public class LongArray : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          fesapiPINVOKE.delete_LongArray(swigCPtr);
        }
  ...
  public LongArray(int nelements) : this(fesapiPINVOKE.new_LongArray(nelements), true) {
  }

  public int getitem(int index) {
    int ret = fesapiPINVOKE.LongArray_getitem(swigCPtr, index);
    return ret;
  }

  public void setitem(int index, int value) {
    fesapiPINVOKE.LongArray_setitem(swigCPtr, index, value);
  }

  public SWIGTYPE_p_long cast() {
    global::System.IntPtr cPtr = fesapiPINVOKE.LongArray_cast(swigCPtr);
  ...
  public static LongArray frompointer(SWIGTYPE_p_long t) {
    global::System.IntPtr cPtr = fesapiPINVOKE.LongArray_frompointer(SWIGTYPE_p_long.getCPtr(t));
