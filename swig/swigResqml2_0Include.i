...
namespace std {
   %template(LocalDepth3dCrsVector) vector<resqml2_0::LocalDepth3dCrs*>;
   %template(LocalTime3dCrsVector) vector<resqml2_0::LocalTime3dCrs*>;
   %template(StratigraphicColumnVector) vector<resqml2_0::StratigraphicColumn*>;
   %template(StratigraphicColumnRankInterpretationVector) vector<resqml2_0::StratigraphicColumnRankInterpretation*>;
   ...
   %template(Grid2dSetRepresentationVector) vector<resqml2_0::Grid2dSetRepresentation*>;
   %template(Grid2dRepresentationVector) vector<resqml2_0::Grid2dRepresentation*>;
   %template(PolylineRepresentationVector) vector<resqml2_0::PolylineRepresentation*>;
   %template(PolylineSetRepresentationVector) vector<resqml2_0::PolylineSetRepresentation*>;
   %template(TriangulatedSetRepresentationVector) vector<resqml2_0::TriangulatedSetRepresentation*>;
   %template(SeismicLineFeatureVector) vector<resqml2_0::SeismicLineFeature*>;
   %template(WellboreFeatureVector) vector<resqml2_0::WellboreFeature*>;
   %template(WellboreTrajectoryRepresentationVector) vector<resqml2_0::WellboreTrajectoryRepresentation*>;
   %template(WellboreMarkerFrameRepresentationVector) vector<resqml2_0::WellboreMarkerFrameRepresentation*>;
   %template(HdfProxyVector) vector<resqml2_0::HdfProxy*>;
   %template(IjkGridRepresentationVector) vector<resqml2_0::IjkGridRepresentation*>;
   %template(UnstructuredGridRepresentationVector) vector<resqml2_0::UnstructuredGridRepresentation*>;
   %template(StringVector) vector<std::string>;
   %template(WellboreMarkerVector) vector<resqml2_0::WellboreMarker*>;
}

namespace gsoap_resqml2_0
{
...
namespace resqml2_0
{
	...
	class HdfProxy : public EpcExternalPartReference
	{
	public:
		bool isOpened();
		void close();
	...
	public:
		...
		gsoap_resqml2_0::eml__LengthUom getProjectedCrsUnit() const;
		std::string getProjectedCrsUnitAsString() const;
		gsoap_resqml2_0::eml__LengthUom getVerticalCrsUnit() const;
		std::string getVerticalCrsUnitAsString() const;
		gsoap_resqml2_0::eml__AxisOrder2d getAxisOrder() const;
	};
	...
	{
	public:
		gsoap_resqml2_0::eml__TimeUom getUnit() const;
	...
	{
	public: 
		void pushBackThrowInterpretation(const gsoap_resqml2_0::resqml2__ThrowKind & throwKind);
	};
	...
	{
	public:
		void pushBackBinaryContact(const gsoap_resqml2_0::resqml2__ContactRelationship & kind, AbstractFeatureInterpretation* subject, const gsoap_resqml2_0::resqml2__ContactVerb & verb, AbstractFeatureInterpretation* directObject);
		void pushBackBinaryContact(const gsoap_resqml2_0::resqml2__ContactRelationship & kind, AbstractFeatureInterpretation* subject, const gsoap_resqml2_0::resqml2__ContactVerb & verb, AbstractFeatureInterpretation* directObject,
				const gsoap_resqml2_0::resqml2__ContactSide & directObjectQualifier);
	};
	...
	public:
		...
		void pushBackStratigraphicBinaryContact(StratigraphicUnitInterpretation* subject, const gsoap_resqml2_0::resqml2__ContactMode & subjectContactMode,
			StratigraphicUnitInterpretation* directObject, const gsoap_resqml2_0::resqml2__ContactMode & directObjectMode,
			class HorizonInterpretation * partOf = NULL);
			
		unsigned int getContactCount() const;
		gsoap_resqml2_0::resqml2__ContactMode getSubjectContactModeOfContact(const unsigned int & contactIndex) const;
		gsoap_resqml2_0::resqml2__ContactMode getDirectObjectContactModeOfContact(const unsigned int & contactIndex) const;
	...
	{
	public:
		void pushBackSubRepresentationPatch(const gsoap_resqml2_0::resqml2__IndexableElements & elementKind, const unsigned int & elementCount, unsigned int * elementIndices, HdfProxy * proxy);
		void pushBackSubRepresentationPatch(const gsoap_resqml2_0::resqml2__IndexableElements & elementKind0, const gsoap_resqml2_0::resqml2__IndexableElements & elementKind1,
		...
		gsoap_resqml2_0::resqml2__IndexableElements getElementKindOfPatch(const unsigned int & patchIndex, const unsigned int & elementIndicesIndex) const;
	...
	{
	public:
		void setSurfaceRole(const gsoap_resqml2_0::resqml2__SurfaceRole & surfaceRole);
		const gsoap_resqml2_0::resqml2__SurfaceRole & getSurfaceRole() const;
	...
	public:
		...
		WellboreMarker* pushBackNewWellboreMarker(const std::string & guid, const std::string & title, const gsoap_resqml2_0::resqml2__GeologicBoundaryKind & geologicBoundaryKind);
	...
	{
	public:
		void pushBackNonSealedContactRepresentation(const unsigned int & pointCount, double * points, class AbstractLocal3dCrs* localCrs, class HdfProxy * proxy);
	};
	...
	public:
		...
		void setGeometryAsCoordinateLineNodes(	const gsoap_resqml2_0::resqml2__PillarShape & mostComplexPillarGeometry, const gsoap_resqml2_0::resqml2__KDirection & kDirectionKind, const bool & isRightHanded,
		...
		// SEISMIC BELOW
		void setGeometryAsCoordinateLineNodes(	const gsoap_resqml2_0::resqml2__PillarShape & mostComplexPillarGeometry,
												const gsoap_resqml2_0::resqml2__KDirection & kDirectionKind,
	...
	public:
		...
		gsoap_resqml2_0::resqml2__ResqmlPropertyKind getEnergisticsPropertyKind() const;
		...
		gsoap_resqml2_0::resqml2__IndexableElements getAttachmentKind() const;
	...
	{
	public:
		void pushBackLongHdf5Array1dOfValues(long * values, const unsigned int & valueCount, HdfProxy * proxy, const long & nullValue, const long &  minimumValue, const long &  maximumValue);
		void pushBackLongHdf5Array1dOfValues(long * values, const unsigned int & valueCount, HdfProxy * proxy, const long & nullValue);
		void pushBackLongHdf5Array2dOfValues(long * values, const unsigned int & valueCountInFastestDim, const unsigned int & valueCountInSlowestDim, HdfProxy * proxy, const long & nullValue, const long &  minimumValue, const long &  maximumValue);
		...
		void pushBackLongHdf5Array3dOfValues(long * values, const unsigned int & valueCountInFastestDim, const unsigned int & valueCountInMiddleDim, const unsigned int & valueCountInSlowestDim, HdfProxy * proxy, const long & nullValue, const long &  minimumValue, const long &  maximumValue);
		...
		void pushBackLongHdf5ArrayOfValues(long * values, hsize_t * numValues, const unsigned int & numDimensionsInArray, class HdfProxy * proxy, const long & nullValue, const long &  minimumValue, const long &  maximumValue);
	...
	public:
		...
		std::string getUomOfResqmlStandardPropertyKindName(const gsoap_resqml2_0::resqml2__ResqmlPropertyKind & resqmlStandardPropertyKindName) const;
		std::string getApplicationPropertyKindNameFromResqmlStandardPropertyKindName(const gsoap_resqml2_0::resqml2__ResqmlPropertyKind & resqmlStandardPropertyKindName, const std::string & application) const;
		gsoap_resqml2_0::resqml2__ResqmlPropertyKind getResqmlStandardPropertyKindNameFromApplicationPropertyKindName(const std::string & applicationPropertyKindName, const std::string & application) const;
